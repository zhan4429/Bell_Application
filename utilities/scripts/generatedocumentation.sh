...
for filename in ${listofmissingfiles[@]}; do
   ...
   outputfile="/home/$USER/Bell_Application/utilities/source/$containername/$containername.rst"
   echo "output file: "$outputfile

   inputpathcontent=$(<$inputpath)  

   mkdir -p /home/$USER/Bell_Application/utilities/source/$containername
